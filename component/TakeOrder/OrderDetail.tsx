...
const OrderDetail = () => {
  ...
  const renderDeliverItem = ({ item }) => (
    ...
    >
      ...
      <Box w={'40%'} >
        <Text fontSize={'lg'} margin={1} alignSelf="flex-end">AU17443133</Text>
      </Box>
    ...
    <>
      <Box
        ...
        <VStack p="7" space="xs">
          ...
          <Text fontSize="md" color="lightBlue.50" fontWeight="bold">
            ...
            >
              ...
              >
                <Box 
                  ...
                  justifyContent="center"
                >
                     <Text fontSize="lg" color="gray.100" bold>欠桶</Text>
                </Box>
                <Box 
                  bg={'#f00'}
                  h={12}
                  ...
                  justifyContent="center"
                >
                  <Text fontSize="lg" color="gray.100" bold>欠款</Text>
                </Box>
                <Icon
        ...
        >
          <Stack width="70%" mr={1} 
            ...
            <Box flexDirection={'row'} w={'100%'} justifyContent="center">
              <Text  pr={'20%'} textAlign="center">掃描鋼瓶 </Text>
              <Text  pl={'20%'} textAlign="center">額外操作 </Text> 
            </Box>
          </Stack>
